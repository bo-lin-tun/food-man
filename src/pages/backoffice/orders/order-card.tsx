        ...
        <div id={id}>
          <div>
            {mergedOrders.map((order, index) => {
              const foundedMenu = menus.find(
                (menu) => menu.id === order.menuId
              );
              ...
              const addonIds = foundedOrders
                .filter(
                  (fo) =>
                    fo.orderSeq === orederSeq && fo.itemId === order.itemId
                )
                .map((o) => o.addonId);
                  ...
                  >
                    ...
                    >
                      ...
                      <Box sx={{ flex: "1 1 10%" }}>
                        {status === "COMPLETE" ? (
                          <Box>
                            {menuPrice && menuPrice * order.quantity} kss
                          </Box>
                        ) : (
                          <Select
                            value={order.status}
                          ...
                          >
                            <MenuItem value={ORDERSTATUS.PENDING}>
                              <Box
                                sx={{ color: "#FF5F00", fontWeight: "bold" }}
                              >
                                {ORDERSTATUS.PENDING}
                              </Box>
                            </MenuItem>
                            <MenuItem value={ORDERSTATUS.COOKING}>
                              <Box
                                sx={{ color: "#C73659", fontWeight: "bold" }}
                              >
                                {ORDERSTATUS.COOKING}
                              </Box>
                            </MenuItem>
                            <MenuItem value={ORDERSTATUS.SEND}>
                              <Box
                                sx={{ color: "#0A6847", fontWeight: "bold" }}
                              >
                                {ORDERSTATUS.SEND}
                              </Box>
                            </MenuItem>
                            <MenuItem value={ORDERSTATUS.COMPLETE}>
                              <Box
                                sx={{ color: "#87A922", fontWeight: "bold" }}
                              >
